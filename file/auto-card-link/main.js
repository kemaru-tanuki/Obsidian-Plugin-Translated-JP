...
var ObsidianAutoCardLinkSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(containerEl)
      .setName("メニュー項目にコマンドを追加")
      .setDesc("右クリックメニュー項目にコマンドを追加するかどうか")
      .addToggle((val) => {
        if (!this.plugin.settings) return;
        return val
...
var LinkMetadataParser = class {
  ...
  getTitle() {
    var _a, _b;
    const ogTitle =
      (_a = this.htmlDoc.querySelector("meta[property='og:title']")) == null
        ? void 0
        : _a.getAttr("content");
    if (ogTitle) return ogTitle;
    const title =
      (_b = this.htmlDoc.querySelector("title")) == null
        ? void 0
        : _b.textContent;
  ...
  getDescription() {
    var _a, _b;
    const ogDescription =
      (_a = this.htmlDoc.querySelector("meta[property='og:description']")) ==
      null
        ? void 0
        : _a.getAttr("content");
    if (ogDescription) return ogDescription;
    const metaDescription =
      (_b = this.htmlDoc.querySelector("meta[name='description']")) == null
        ? void 0
        : _b.getAttr("content");
  ...
  getFavicon() {
    return __async(this, null, function* () {
      var _a;
      const favicon =
        (_a = this.htmlDoc.querySelector("link[rel='icon']")) == null
          ? void 0
          : _a.getAttr("href");
      if (favicon) return yield this.fixImageUrl(favicon);
    });
  }
  getImage() {
    return __async(this, null, function* () {
      var _a;
      const ogImage =
        (_a = this.htmlDoc.querySelector("meta[property='og:image']")) == null
          ? void 0
          : _a.getAttr("content");
      if (ogImage) return yield this.fixImageUrl(ogImage);
    });
  }
  fixImageUrl(url) {
    return __async(this, null, function* () {
  ...
  fetchLinkMetadata(url) {
    return __async(this, null, function* () {
      ...
      if (!res || res.status != 200) {
        console.log(
          `bad response. response status code was ${
            res == null ? void 0 : res.status
          }`
        );
        return;
      }
...
var CodeBlockProcessor = class {
  ...
  genLinkEl(data) {
    ...
    new import_obsidian3.ButtonComponent(containerEl)
...
${data.url}`
  ...
  getLocalImagePath(link) {
    ...
    const imageRelativePath =
      (_a = this.app.metadataCache.getFirstLinkpathDest(
...
var ObsidianAutoCardLink = class extends import_obsidian4.Plugin {
  constructor() {
    ...
    this.onEditorMenu = (menu) => {
      var _a;
      if (!((_a = this.settings) == null ? void 0 : _a.showInMenuItem)) return;
      menu.addItem((item) => {
        item
          .setTitle("URLを貼り付けてカードリンクに変換")
          .setIcon("paste")
          .onClick(() =>
            __async(this, null, function* () {
