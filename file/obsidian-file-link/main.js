...
var FileLinkSettingTab = /** @class */ (function (_super) {
  ...
  FileLinkSettingTab.prototype.display = function () {
    ...
    new obsidian.Setting(containerEl)
      .setName("複数ファイルのリストスタイル")
      .setDesc("各ファイルリンクの前に表示される文字を指定します。")
    ...
    new obsidian.Setting(containerEl)
      .setName("ファイルを埋め込む")
      .setDesc("ファイルを Obsidian にコピーしてノートに埋め込みます。")
      .addToggle(function (toggle) {
        return toggle
          .setValue(_this.plugin.settings.embedFile)
          .onChange(function () {
            return __awaiter(_this, void 0, void 0, function () {
              return __generator(this, function (_a) {
                switch (_a.label) {
...
var FileEmbeder = /** @class */ (function () {
  ...
  FileEmbeder.prototype.getMarkdownLink = function (filePath, printPrefix) {
    ...
    var linkPath = this.settings.linkFolder ? pathInfo.dir : pathInfo.fullPath;
...
var FileLinkModal = /** @class */ (function (_super) {
  ...
  FileLinkModal.prototype.onOpen = function () {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        checkboxEmbed = createCheckboxGroup(
          "embed",
          "ファイルを埋め込む",
          this.plugin.settings.embedFile
        );
        checkboxFileFolder = createCheckboxGroup(
          "file-folder",
          "Link folder",
          this.plugin.settings.linkFolder
        );
        checkboxFileEnding = createCheckboxGroup(
          "file-ending",
          "ファイル拡張子を表示",
            ...
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 3:
                  error_1 = _a.sent();
                  new obsidian.Notice(
                    "Error selecting files: " + error_1.message
                  );
                  return [3 /*break*/, 4];
                case 4:
                  return [2 /*return*/];
        ...
        submitButton.addEventListener("click", function () {
          if (_this.filePaths.length > 0) {
            ...
            if (checkboxEmbed.checked) {
              ...
              var linkString_1 = "";
              _this.filePaths.forEach(function (file) {
                linkString_1 += fe_1.getMarkdownLink(
                  file,
                  _this.filePaths.length > 1
                );
              });
            ...
            _this.close();
            new obsidian.Notice(
              "Added ".concat(_this.filePaths.length, " file link(s)")
            );
          } else {
  ...
  FileLinkModal.prototype.addAtCursor = function (s) {
    var markdownView = this.app.workspace.getActiveViewOfType(
