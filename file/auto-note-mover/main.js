  ...
  add_auto_note_mover_setting() {
    ...
    useRegexToCheckForTags.append(
      ...
      descEl.createEl("strong", {
        text: "提案されたタグをそのまま使用したい場合は、この設定を無効にすることをお勧めします。",
      })
    );
    new import_obsidian5.Setting(this.containerEl)
      .setName("タグのチェックに正規表現を使用")
    ...
    ruleDesc.append(
      ...
      descEl.createEl("strong", {
        text: "タグまたはタイトルのいずれかを設定できます。",
      }),
      descEl.createEl("br"),
      "3. ルールは上から順にチェックされます。ノートは",
      descEl.createEl("strong", { text: "最初に一致したルールのフォルダに移動されます。" }),
      descEl.createEl("br"),
      "タグ：必ず",
