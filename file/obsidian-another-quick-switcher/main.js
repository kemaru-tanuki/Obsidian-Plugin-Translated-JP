...
var createDefaultHotkeys = () => ({
  main: {
    上に移動: [{ modifiers: ["Mod"], key: "p" }],
    下に移動: [{ modifiers: ["Mod"], key: "n" }],
    "入力クリア": [{ modifiers: ["Mod"], key: "d" }],
    "入力置換": [{ modifiers: [], key: "Tab" }],
    開く: [{ modifiers: [], key: "Enter" }],
    "新しいタブで開く": [{ modifiers: ["Mod"], key: "Enter" }],
    "新しいペインで開く（水平）": [{ modifiers: ["Mod"], key: "-" }],
    "新しいペインで開く（垂直）": [{ modifiers: ["Mod"], key: "i" }],
    "新しいウィンドウで開く": [{ modifiers: ["Mod"], key: "o" }],
    "ポップアップで開く": [],
    "バックグラウンドで新しいタブに開く": [{ modifiers: ["Alt"], key: "o" }],
    "すべてを新しいタブで開く": [{ modifiers: ["Mod", "Shift", "Alt"], key: "o" }],
    プレビュー: [{ modifiers: ["Mod"], key: "," }],
    作成: [{ modifiers: ["Shift"], key: "Enter" }],
    "新しいタブで作成": [{ modifiers: ["Mod", "Shift"], key: "Enter" }],
    "新しいウィンドウで作成": [{ modifiers: ["Mod", "Shift"], key: "o" }],
    "新しいポップアップで作成": [],
    "デフォルトアプリで開く": [],
    "システムエクスプローラで表示": [],
    "Google で開く": [{ modifiers: ["Mod"], key: "g" }],
    "最初の URL を開く": [{ modifiers: ["Mod"], key: "]" }],
    "エディタに挿入": [{ modifiers: ["Alt"], key: "Enter" }],
    "バックグラウンドでエディタに挿入": [],
    "すべてをエディタに挿入": [{ modifiers: ["Alt", "Shift"], key: "Enter" }],
    "バックリンクを表示": [{ modifiers: ["Mod"], key: "h" }],
    "リンクを表示": [{ modifiers: ["Mod"], key: "l" }],
    "すべての結果を表示": [{ modifiers: ["Shift", "Alt"], key: "a" }],
    "次に進む": [{ modifiers: ["Alt"], key: "ArrowRight" }],
    "前に戻る": [{ modifiers: ["Alt"], key: "ArrowLeft" }],
    "開いている場合に閉じる": [],
    閉じる: [{ modifiers: [], key: "Escape" }]
  },
  folder: {
    上に移動: [{ modifiers: ["Mod"], key: "p" }],
    下に移動: [{ modifiers: ["Mod"], key: "n" }],
  ...
  header: {
    ...
    下に移動: [{ modifiers: ["Mod"], key: "n" }],
    "入力クリア": [{ modifiers: ["Mod"], key: "d" }],
    "次の検索結果に移動": [{ modifiers: [], key: "Tab" }],
    "前の検索結果に移動": [{ modifiers: ["Shift"], key: "Tab" }],
    "自動プレビューを切り替え": [{ modifiers: ["Mod"], key: "," }],
    "すべてをエディタに挿入": [{ modifiers: ["Alt", "Shift"], key: "Enter" }],
    閉じる: [{ modifiers: [], key: "Escape" }]
  },
  backlink: {
  ...
  grep: {
    検索: [{ modifiers: [], key: "Tab" }],
    上に移動: [{ modifiers: ["Mod"], key: "p" }],
    下に移動: [{ modifiers: ["Mod"], key: "n" }],
    "入力クリア": [{ modifiers: ["Mod"], key: "d" }],
    "パスをクリア": [{ modifiers: ["Alt"], key: "d" }],
    "パスを ./ に設定": [{ modifiers: ["Alt"], key: "c" }],
    開く: [{ modifiers: [], key: "Enter" }],
    "新しいタブで開く": [{ modifiers: ["Mod"], key: "Enter" }],
    "新しいペインで開く（水平）": [{ modifiers: ["Mod"], key: "-" }],
    "新しいペインで開く（垂直）": [{ modifiers: ["Mod"], key: "i" }],
...
var AnotherQuickSwitcherSettingTab = class extends import_obsidian3.PluginSettingTab {
  ...
  display() {
    ...
    containerEl.empty();
    containerEl.createEl("h2", { text: "Another Quick Switcher - 設定" });
  ...
  addGeneralSettings(containerEl) {
    new import_obsidian3.Setting(containerEl).setName("検索遅延ミリ秒").setDesc("キーボード操作が遅い場合は、値を増やしてみてください").addSlider(
    ...
    new import_obsidian3.Setting(containerEl).setName("提案の最大数").addSlider(
    ...
    new import_obsidian3.Setting(containerEl).setName("アクセント/発音区別符号を正規化").addToggle((tc) => {
      tc.setValue(
    ...
    if (this.plugin.settings.normalizeAccentsAndDiacritics) {
      containerEl.createEl("div", {
        text: "！有効にすると、無効時の２～５倍程度遅くなります",
        cls: "another-quick-switcher__settings__warning"
      });
    }
    new import_obsidian3.Setting(containerEl).setName("選択された単語をデフォルトの入力クエリとして使用").addToggle((tc) => {
      tc.setValue(
    ...
    new import_obsidian3.Setting(containerEl).setName("重複タブを防止").setDesc(
  ...
  addAppearanceSettings(containerEl) {
    containerEl.createEl("h3", { text: "\u{1F441} 外観" });
    new import_obsidian3.Setting(containerEl).setName("ディレクトリを表示").addToggle((tc) => {
    ...
    if (this.plugin.settings.showDirectory) {
      new import_obsidian3.Setting(containerEl).setName("新しい行にディレクトリを表示").setClass("another-quick-switcher__settings__nested").addToggle((tc) => {
      ...
      new import_obsidian3.Setting(containerEl).setName("ディレクトリのフルパスを表示").setClass("another-quick-switcher__settings__nested").addToggle((tc) => {
    ...
    new import_obsidian3.Setting(containerEl).setName("キーワード一致時にエイリアスをタイトルとして表示").setDesc(
    ...
    new import_obsidian3.Setting(containerEl).setName("エイリアスをタイトルとして表示").addToggle((tc) => {
    ...
    new import_obsidian3.Setting(containerEl).setName("タイトルの下に 'description' プロパティを表示").setDesc(
    ...
    new import_obsidian3.Setting(containerEl).setName("既存のファイルのみを表示").addToggle((tc) => {
    ...
    new import_obsidian3.Setting(containerEl).setName("ガターアイコンを非表示").addToggle((tc) => {
    ...
    new import_obsidian3.Setting(containerEl).setName("ホットキーガイドを非表示").addToggle((tc) => {
  ...
  addHotKeysInDialogSettings(containerEl) {
    containerEl.createEl("h3", { text: "\u2328 ダイアログ内のホットキー" });
    ...
    const addHotkeyItems = (dialogKey, div) => {
      ...
      const addHotKeyItem = (name, command) => {
        new import_obsidian3.Setting(div).setName(name).setClass("another-quick-switcher__settings__dialog-hotkey-item").addText((cb) => {
          ...
          var _a;
          const dialog = this.plugin.settings.hotkeys[dialogKey];
          return cb.setTooltip("有効な場合、ホットキーガイドを表示").setValue(!((_a = dialog[command][0]) == null ? void 0 : _a.hideHotkeyGuide)).onChange(async (showHotkeyGuide) => {
    ...
    const addHotkeysForDialog = (dialogKey, dialogName) => {
      ...
      li.createEl("ul").createEl("li", {
        text: "スペースキーの場合は、値を 'Space' に設定してください。"
      });
      const ul = createEl("ul");
      ul.createEl("li", {
        text: "'Ctrl + A'は Ctrl キーと A キーを同時に押すことを意味します。"
      });
      ul.createEl("li", {
        text: "Windows では Ctrl の代わりに、macOS では Cmd の代わりに'Mod'を使用してください。"
      });
      ul.append(li);
    ...
    addHotkeysForDialog("main", "メインダイアログ");
    addHotkeysForDialog("folder", "フォルダダイアログ");
    addHotkeysForDialog("header", "ヘッダーダイアログ");
    addHotkeysForDialog("backlink", "バックリンクダイアログ");
    addHotkeysForDialog("link", "リンクダイアログ");
    addHotkeysForDialog("in-file", "ファイル内ダイアログ");
    addHotkeysForDialog("grep", "Grep ダイアログ");
  }
  addSearchSettings(containerEl) {
    containerEl.createEl("h3", { text: "\u{1F50D} 検索コマンド" });
    ...
    new import_obsidian3.Setting(containerEl).setHeading().addButton((btn) => {
      btn.setButtonText("追加").setTooltip("新しいコマンドを追加").setCta().setClass(
      ...
      btn.setButtonText("保存").setTooltip(
...
`.trim(),
        ...
        new import_obsidian3.Notice("保存してコマンドを再読み込み");
      });
    });
    new import_obsidian3.Setting(containerEl).setName("すべての検索コマンドをリセット").setClass("another-quick-switcher__settings__danger").setDesc(
      ...
      btn.setButtonText("リセット").setTooltip("すべての検索コマンドをリセット!!").setDisabled(this.resetLock).onClick(() => {
    ...
    new import_obsidian3.Setting(containerEl).setName("除外プレフィックス").setDesc(
    ...
    new import_obsidian3.Setting(containerEl).setName("自動エイリアス変換").setDesc(
    ...
    if (this.plugin.settings.searchesAutoAliasTransform.enabled) {
      ...
      new import_obsidian3.Setting(containerEl).setName("エイリアスパターン").setDesc(
      ...
      new import_obsidian3.Setting(containerEl).setName("エイリアスフォーマット").setDesc(
  ...
  addSearchCommandSetting(containerEl, command) {
    ...
    new import_obsidian3.Setting(div).setName("検索方法").setDesc("検索対象の有効/無効を切り替えるボタンをクリック").addButton((bc) => {
      const coloring = () => {
      ...
      bc.setButtonText("タグ").setClass(buttonClass).onClick(async () => {
      ...
      bc.setButtonText("ヘッダー").setClass(buttonClass).onClick(async () => {
      ...
      bc.setButtonText("リンク").setClass(buttonClass).onClick(async () => {
      ...
      bc.setButtonText("プロパティ").setClass(buttonClass).onClick(async () => {
    ...
    if (command.searchBy.property) {
      new import_obsidian3.Setting(div).setName("検索対象のプロパティキー").setDesc("改行区切りで複数指定可能").addTextArea((tc) => {
    ...
    new import_obsidian3.Setting(div).setName("検索対象").addDropdown((dc) => {
      dc.addOptions(mirror([...searchTargetList])).setValue(command.searchTarget).onChange(async (value) => {
        command.searchTarget = value;
      });
    });
    new import_obsidian3.Setting(div).setName('Allow fuzzy search for "検索対象"').addToggle((cb) => {
    ...
    new import_obsidian3.Setting(div).setName("最小ファジーマッチスコア").setDesc(
      "指定スコア以上の提案のみ表示"
    ).addSlider(
    ...
    new import_obsidian3.Setting(div).setName("対象拡張子").setDesc(
    ...
    new import_obsidian3.Setting(div).setName("フローティング").addToggle((cb) => {
      cb.setValue(command.floating).onChange(async (value) => {
        command.floating = value;
        this.display();
      });
    });
    new import_obsidian3.Setting(div).setName("フロントマターを表示").addToggle((cb) => {
    ...
    if (command.showFrontMatter) {
      new import_obsidian3.Setting(div).setName("除外するフロントマターキー").setDesc("改行で複数パターンを設定可能").addTextArea((tc) => {
    ...
    new import_obsidian3.Setting(div).setName("デフォルト入力").setDesc("ダイアログ開封時のデフォルト入力文字列").addText(
      (tc) => tc.setValue(command.defaultInput).setPlaceholder("(ex: #todo )").onChange(async (value) => {
        command.defaultInput = value;
      })
    );
    new import_obsidian3.Setting(div).setName("最後の入力を復元").setDesc(
    ...
    new import_obsidian3.Setting(div).setName("コマンドプレフィックス").setDesc(
    ...
    new import_obsidian3.Setting(div).setName("ソート優先順位").setDesc(df).addTextArea((tc) => {
    ...
    new import_obsidian3.Setting(div).setName("プレフィックスパスパターンを追加").setDesc(
    ...
    new import_obsidian3.Setting(div).setName("プレフィックスパスパターンを除外").setDesc(
  ...
  addHeaderSearchSettings(containerEl) {
    containerEl.createEl("h3", { text: "\u{1F4D2} ヘッダー検索" });
    new import_obsidian3.Setting(containerEl).setName("フローティングモードでの自動プレビュー").addToggle((tc) => {
      tc.setValue(
  ...
  addBacklinkSettings(containerEl) {
    containerEl.createEl("h3", { text: "\u{1F50D} バックリンク検索" });
    new import_obsidian3.Setting(containerEl).setName('Exclude prefix path patterns for "検索：バックリンク"').setDesc(
  ...
  addInFileSettings(containerEl) {
    containerEl.createEl("h3", { text: "\u{1F50D} ファイル内検索" });
    new import_obsidian3.Setting(containerEl).setName("コンテキスト行数").setDesc(
    ...
    new import_obsidian3.Setting(containerEl).setName("一致した単語の周囲の最大表示長").setDesc(
      "一致した単語の前後に表示する最大文字数。"
    ).addSlider(
  ...
  addGrepSettings(containerEl) {
    ...
    new import_obsidian3.Setting(containerEl).setName("Ripgrep コマンド").setDesc("ripgrep を実行できるコマンド").addText(
      (tc) => tc.setValue(this.plugin.settings.ripgrepCommand).onChange(async (value) => {
        this.plugin.settings.ripgrepCommand = value;
        await this.plugin.saveSettings();
      })
    );
    new import_obsidian3.Setting(containerEl).setName("拡張子").addText(
  ...
  addMoveSettings(containerEl) {
    containerEl.createEl("h3", { text: "\u{1F4C1} ファイルを別のフォルダに移動" });
    new import_obsidian3.Setting(containerEl).setName('"「ファイルを別のフォルダに移動」のプレフィックスパスパターンを除外"').setDesc(
      "設定すると、パターンのいずれかで始まるパスを持つフォルダは提案されません。改行で複数のパターンを設定できます"
    ).addTextArea((tc) => {
      const el = tc.setPlaceholder("Prefix match patterns").setValue(
  ...
  addDebugSettings(containerEl) {
    ...
    new import_obsidian3.Setting(containerEl).setName("コンソールにパフォーマンスに関するログを表示").addToggle((tc) => {
      tc.setValue(
    ...
    new import_obsidian3.Setting(containerEl).setName("ダイアログにファジーマッチスコアを表示").addToggle((tc) => {
