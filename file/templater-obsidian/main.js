...
var Ki = (n) => qn(n, "__esModule", { value: !0 });
var Aa = (n, e) => {
    Ki(n);
    for (var t in e) qn(n, t, { get: e[t], enumerable: !0 });
  },
  _a = (n, e, t) => {
    if ((e && typeof e == "object") || typeof e == "function")
      for (let r of ma(e))
        !ha.call(n, r) &&
          ...
          qn(n, r, {
            get: () => e[r],
            enumerable: !(t = da(e, r)) || t.enumerable,
          });
    return n;
  },
  ee = (n) =>
...
Aa(exports, { default: () => Pi });
var xr = ee(require("obsidian"));
var L = ee(require("obsidian"));
var Yi = ee(require("obsidian"));
function oe(n) {
  let e = new Yi.Notice("", 8e3);
  n instanceof M && n.console_msg
...
async function Te(n, e) {
  try {
    ...
    return t instanceof M ? oe(t) : oe(new M(e, t.message)), null;
  }
}
function ke(n, e) {
  try {
    ...
    return oe(new M(e, t.message)), null;
  }
}
var re = (function () {
  function n() {}
  ...
  return (
    (n.register = function (e) {
      ...
      t.registerDocNodes("@microsoft/tsdoc", [
        { docNodeKind: g.Block, constructor: Ut },
        { docNodeKind: g.BlockTag, constructor: Ln },
        { docNodeKind: g.CodeSpan, constructor: Hn },
        { docNodeKind: g.Comment, constructor: $n },
        { docNodeKind: g.DeclarationReference, constructor: Kn },
        { docNodeKind: g.ErrorText, constructor: kt },
        { docNodeKind: g.EscapedText, constructor: Rn },
        { docNodeKind: g.Excerpt, constructor: j },
        { docNodeKind: g.FencedCode, constructor: Yn },
        { docNodeKind: g.HtmlAttribute, constructor: Un },
        { docNodeKind: g.HtmlEndTag, constructor: Gn },
        { docNodeKind: g.HtmlStartTag, constructor: Wn },
        { docNodeKind: g.InheritDocTag, constructor: pn },
        { docNodeKind: g.InlineTag, constructor: Gt },
        { docNodeKind: g.LinkTag, constructor: Vn },
        { docNodeKind: g.MemberIdentifier, constructor: un },
        { docNodeKind: g.MemberReference, constructor: zn },
        { docNodeKind: g.MemberSelector, constructor: Jn },
        { docNodeKind: g.MemberSymbol, constructor: Qn },
        { docNodeKind: g.Paragraph, constructor: at },
        { docNodeKind: g.ParamBlock, constructor: fn },
        { docNodeKind: g.ParamCollection, constructor: ln },
        { docNodeKind: g.PlainText, constructor: Ge },
        { docNodeKind: g.Section, constructor: At },
        { docNodeKind: g.SoftBreak, constructor: Xn },
      ]),
...
var Sr = (function () {
  function n() {
    (this._tagDefinitions = []),
      ...
      (this._validation = new kr()),
      (this._docNodeManager = new Er()),
  ...
  return (
    ...
    (n.prototype.isTagSupported = function (e) {
      return (
        this._requireTagToBeDefined(e), this._supportedTagDefinitions.has(e)
      );
    }),
...
var ya = (function () {
  ...
  er = (function (n) {
    ...
    function e(t, r) {
      ...
      return (
        (i._nodes = []), r !== void 0 && r.length > 0 && i.appendNodes(r), i
      );
    }
    return (
  ...
  Ut = (function (n) {
    ...
    function e(t) {
      ...
      return (
        ...
        (r._content = new At({ configuration: r.configuration })),
        r
      );
    }
    return (
...
var Pr = (function () {
  ...
  return (
    (n.trimSpacesInParagraph = function (e) {
      return Wi.transform(e);
    }),
    n
  );
})();
var Nr = function (n, e, t) {
      ...
      if (e !== void 0)
        switch (e.kind) {
          ...
          case g.HtmlStartTag:
            ...
            for (
              ...
              P && this._writeContent(" "),
                this._renderNode(O),
                (P =
                  O.spacingAfterValue === void 0 ||
                  O.spacingAfterValue.length === 0);
            }
          ...
          case g.Section:
            ...
            break;
          case g.Paragraph:
            var Q = Pr.trimSpacesInParagraph(e);
            Q.nodes.length > 0 &&
...
var Sa = (function () {
  ...
  $n = (function (n) {
    ...
    function e(t) {
      var r = n.call(this, t) || this;
      return (
        (r.summarySection = new At({ configuration: r.configuration })),
        (r.remarksBlock = void 0),
        (r.privateRemarks = void 0),
        (r.deprecatedBlock = void 0),
        (r.params = new ln({ configuration: r.configuration })),
        (r.typeParams = new ln({ configuration: r.configuration })),
        (r.returnsBlock = void 0),
        (r.modifierTagSet = new Dr()),
        (r._seeBlocks = []),
        (r._customBlocks = []),
        r
      );
...
var Mr = (function () {
  ...
  return (
    ...
    (n.prototype.addMessageForTextRange = function (e, t, r) {
      this.addMessage(new dn({ messageId: e, messageText: t, textRange: r }));
    }),
...
var Or = (function () {
  function n(e, t) {
    (this.commentRange = We.empty),
      ...
      (this.sourceRange = t),
      (this.docComment = new $n({ configuration: this.configuration })),
      (this.log = new Mr());
  }
  return n;
})();
    ...
    (n.extract = function (e) {
      for (
        ...
        switch (d) {
          ...
          case pe.BeginComment2:
            if (y === "*")
              E === " " && ++c, (a = c), (l = c), (d = pe.CollectingFirstLine);
            else
              return (
                e.log.addMessageForTextRange(
                  v.CommentOpeningDelimiterSyntax,
...
var mn = (function () {
  ...
  return (
    (n.readTokens = function (e) {
      ...
      return (
        r
          ? t.push(new St(u.EndOfInput, r.getNewRange(r.end, r.end), r))
          : t.push(new St(u.EndOfInput, We.empty, We.empty)),
        t
      );
    }),
      ...
      for (var r = t.buffer, i = t.end, o = t.pos, a = void 0, l = o; o < i; ) {
        ...
        d === void 0 && (d = u.Other),
          (a !== void 0 && d === a && n._isMultiCharacterToken(a)) ||
            (a !== void 0 && e.push(new St(a, t.getNewRange(l, o), t)),
            (l = o),
            (a = d)),
          ++o;
      }
      a !== void 0 && e.push(new St(a, t.getNewRange(l, o), t)),
        e.push(new St(u.Newline, t.getNewRange(t.end, t.end), t));
    }),
...
var Br = (function () {
  function n(e, t) {
    if (((this._parserContext = e), (this.tokens = e.tokens), t)) {
      ...
      (this._readerStartIndex = 0), (this._readerEndIndex = this.tokens.length);
...
var Qi = (function () {
  ...
  return (
    (n.prototype.parse = function () {
      for (var e = new Br(this._parserContext), t = !1; !t; )
    ...
    (n.prototype._performValidationChecks = function () {
      ...
      e.deprecatedBlock &&
        (rr.hasAnyTextContent(e.deprecatedBlock) ||
        ...
        e.inheritDocTag &&
          ...
          rr.hasAnyTextContent(e.summarySection) &&
    ...
    (n.prototype._parseBackslashEscape = function (e) {
      ...
      return new Rn({
        parsed: !0,
        configuration: this._configuration,
        escapeStyle: nr.CommonMarkBackslash,
    ...
    (n.prototype._parseInlineTag = function (e) {
      ...
      for (var m = !1; !m; )
        switch (e.peekTokenKind()) {
          ...
          case u.Backslash:
            if ((e.readToken(), !mn.isPunctuation(e.peekTokenKind()))) {
      ...
      var b = e.extractAccumulatedSequence(),
        ...
        k = new Br(
          this._parserContext,
          y || _t.createEmpty(this._parserContext)
        ),
        w;
      switch (P) {
      ...
      return this._validateTagDefinition(O, o, !0, l, w), w;
    }),
    ...
    (n.prototype._parseFencedCode = function (e) {
      ...
      var O = e.extractAccumulatedSequence(),
        $ = O.getNewSequence(O.startIndex, P),
        K = O.getNewSequence(P, k),
        C = O.getNewSequence(k, O.endIndex);
      for (l = !1; !l; )
        switch (e.peekTokenKind()) {
          case u.Spacing:
            e.readToken();
...
var Xi = (function () {
  ...
  return (
    (n.splitParagraphs = function (e) {
      if (e instanceof At) n.splitParagraphsForSection(e);
      else
...
var Fr = (function () {
  function n(e) {
    e ? (this.configuration = e) : (this.configuration = new Sr());
  }
  return (
    ...
    (n.prototype.parseRange = function (e) {
      var t = new Or(this.configuration, e);
      if (Ji.extract(t)) {
        t.tokens = mn.readTokens(t.lines);
        var r = new Qi(t);
        r.parse(), Xi.splitParagraphs(t.docComment);
      }
      return t;
    }),
    n
...
var Zi = ee(require("obsidian")),
  Ir = class extends Zi.TFile {
    constructor(e) {
...
function Va(n, e) {
  ...
  if (!t) throw new M(`Folder "${e}" doesn't exist`);
  if (!(t instanceof Ve.TFolder)) throw new M(`${e} is a file, not a folder`);
  return t;
}
function Ct(n, e) {
  e = (0, Ve.normalizePath)(e);
  let t = n.vault.getAbstractFileByPath(e);
  if (!t) throw new M(`File "${e}" doesn't exist`);
  if (!(t instanceof Ve.TFile)) throw new M(`${e} is a folder, not a file`);
  return t;
}
function ze(n, e) {
  let t = Va(n, e),
...
function za(n, e) {
  let r = new Fr().parseString(e),
    i = new Ir(n);
  return (
    (i.description = Ja(r.docComment.summarySection)),
    (i.returns = Qa(r.docComment.returnsBlock)),
    (i.arguments = Xa(r.docComment.params)),
    i
  );
}
function Ja(n) {
...
var Co = ee(require("obsidian"));
var ko = ee(require("obsidian"));
var ie = "top",
  ue = "bottom",
  ce = "right",
  ae = "left",
  ...
  Jt = "popper",
  ao = "reference",
  $r = xt.reduce(function (n, e) {
    return n.concat([e + "-" + lt, e + "-" + Pt]);
  }, []),
  cr = [].concat(xt, [ar]).reduce(function (n, e) {
    return n.concat([e, e + "-" + lt, e + "-" + Pt]);
  }, []),
  Za = "beforeRead",
  es = "read",
  ts = "afterRead",
...
function fe(n) {
  var e = X(n).HTMLElement;
  return n instanceof e || n instanceof HTMLElement;
}
function Qt(n) {
  if (typeof ShadowRoot == "undefined") return !1;
  var e = X(n).ShadowRoot;
...
function ut(n) {
  return de(n) === "html"
    ? n
    : n.assignedSlot || n.parentNode || (Qt(n) ? n.host : null) || he(n);
}
function lo(n) {
...
function ps(n) {
  ...
  var i = ut(n);
  for (Qt(i) && (i = i.host); fe(i) && ["html", "body"].indexOf(de(i)) < 0; ) {
    var o = ve(i);
    if (
      o.transform !== "none" ||
      o.perspective !== "none" ||
...
function Ie(n) {
  for (var e = X(n), t = lo(n); t && Kr(t) && ve(t).position === "static"; )
    t = lo(t);
  return t &&
...
function fo(n) {
  ...
  if (d) {
    ...
    if (i === ae || ((i === ie || i === ue) && o === Pt)) {
      K = ce;
      var Q = y && I === H && H.visualViewport ? H.visualViewport.width : I[te];
      (E -= Q - r.width), (E *= c ? 1 : -1);
    }
  }
  var h = Object.assign({ position: l }, d && ms),
    S = m === !0 ? gs({ x: E, y: k }, X(t)) : { x: E, y: k };
  if (((E = S.x), (k = S.y), c)) {
    var f;
  ...
  return (
    o &&
      d.forEach(function (m) {
        m.addEventListener("scroll", t.update, lr);
      }),
    l && c.addEventListener("resize", t.update, lr),
    function () {
      o &&
        d.forEach(function (m) {
          m.removeEventListener("scroll", t.update, lr);
        }),
        l && c.removeEventListener("resize", t.update, lr);
    }
  );
}
var go = {
...
function It(n) {
  return Pe(he(n)).left + Ft(n).scrollLeft;
}
function Rr(n, e) {
  var t = X(n),
    r = he(n),
  ...
  return { width: o, height: a, x: l + It(n), y: c };
}
function Yr(n) {
  var e,
    t = he(n),
...
function yt(n, e) {
  ...
  var r = ur(n),
    ...
    o = X(r),
    a = i ? [o].concat(o.visualViewport || [], qt(r) ? r : []) : r,
    l = e.concat(a);
  return i ? l : l.concat(yt(ut(a)));
}
function en(n) {
...
function ho(n, e, t) {
  return e === sr ? en(Rr(n, t)) : De(e) ? ys(e, t) : en(Yr(he(n)));
}
function js(n) {
  var e = yt(ut(n)),
  ...
  return De(r)
    ? e.filter(function (i) {
        return De(i) && An(i, r) && de(i) !== "body";
      })
    : [];
}
function Ur(n, e, t, r) {
  var i = e === "clippingParents" ? js(n) : [].concat(e),
    o = [].concat(i, [t]),
    a = o[0],
    l = o.reduce(function (c, d) {
      var m = ho(n, d, r);
      return (
        (c.top = Fe(m.top, c.top)),
        (c.right = Nt(m.right, c.right)),
        (c.bottom = Nt(m.bottom, c.bottom)),
...
function qe(n, e) {
  ...
  var t = e,
    ...
    k = t.padding,
    w = k === void 0 ? 0 : k,
    O = xn(typeof w != "number" ? w : yn(w, xt)),
    $ = b === Jt ? ao : Jt,
    K = n.rects.popper,
    C = n.elements[P ? $ : b],
    H = Ur(De(C) ? C : C.contextElement || he(n.elements.popper), c, m, a),
    I = Pe(n.elements.reference),
    J = jn({ reference: I, element: K, strategy: "absolute", placement: i }),
    te = en(Object.assign({}, K, J)),
    ne = b === Jt ? te : I,
    Q = {
...
function Ts(n) {
  var e = n.state,
    ...
    i = t.offset,
    o = i === void 0 ? [0, 0] : i,
    a = cr.reduce(function (m, y) {
      return (m[y] = Es(y, e.rects, o)), m;
    }, {}),
    l = a[e.placement],
    c = l.x,
    d = l.y;
  ...
  if (!!I) {
    if (o) {
      var f,
        ...
        Z = D[be],
        et = Bt(0, J[Ae], B[Ae]),
        W = K ? J[Ae] / 2 - Ht - et - q - Q.mainAxis : Re - et - q - Q.mainAxis,
        ye = K
          ? -J[Ae] / 2 + Ht + et + Z + Q.mainAxis
          : Ze + et + Z + Q.mainAxis,
        wt = e.elements.arrow && Ie(e.elements.arrow),
        kn = wt ? (C === "y" ? wt.clientTop || 0 : wt.clientLeft || 0) : 0,
        tt = (f = h == null ? void 0 : h[C]) != null ? f : 0,
        nt = _e + W - tt - kn,
        mt = _e + ye - tt,
        bt = Bt(E ? Nt(Ke, nt) : Ke, _e, E ? Fe(Ee, mt) : Ee);
      (I[C] = bt), (S[C] = bt - _e);
    }
    if (l) {
      var Sn,
        ...
        Pn = rt + w[Cn],
        Nn = rt - w[Dn],
        on = [ie, ae].indexOf(O) !== -1,
        Et = (Sn = h == null ? void 0 : h[H]) != null ? Sn : 0,
        Mn = on ? Pn : rt - J[$t] - te[$t] - Et + Q.altAxis,
        Ye = on ? rt + J[$t] + te[$t] - Et - Q.altAxis : Nn,
        se = E && on ? po(Mn, rt, Ye) : Bt(E ? Mn : Pn, rt, E ? Ye : Nn);
      (I[H] = se), (S[H] = se - rt);
    }
    e.modifiersData[r] = S;
  }
...
var bo = { placement: "bottom", modifiers: [], strategy: "absolute" };
function Eo() {
    ...
    var m = {
      ...
      E = {
        ...
        setOptions: function (O) {
          ...
          var K = Qr(Zr([].concat(r, m.options.modifiers)));
          return (
        ...
        forceUpdate: function () {
          if (!b) {
            ...
            if (!!Eo($, K)) {
              (m.rects = {
                reference: Jr($, Ie(K), m.options.strategy === "fixed"),
                popper: Mt(K),
              }),
                (m.reset = !1),
    ...
    function P() {
      m.orderedModifiers.forEach(function (w) {
        ...
        if (typeof C == "function") {
          var H = C({ state: m, name: O, instance: E, options: K }),
            I = function () {};
          y.push(H || I);
        }
      });
...
var Ps = [go, vo, mo, co, jo, Ao, wo, uo, yo],
  ei = To({ defaultModifiers: Ps });
var Ns = (n, e) => ((n % e) + e) % e,
  So = class {
    constructor(e, t, r) {
      (this.owner = e),
    ...
    setSelectedItem(e, t) {
      let r = Ns(e, this.suggestions.length),
  ...
  vn = class {
    constructor(e, t) {
      (this.app = e),
        (this.inputEl = t),
        (this.scope = new ko.Scope()),
        (this.suggestEl = createDiv("suggestion-container"));
      let r = this.suggestEl.createDiv("suggestion");
      (this.suggest = new So(this, r, this.scope)),
    ...
    open(e, t) {
      this.app.keymap.pushScope(this.scope),
        ...
        (this.popper = ei(t, this.suggestEl, {
...
var Po = {
  ...
  ti = class extends L.PluginSettingTab {
    constructor(e) {
      super(e.app, e);
      this.plugin = e;
    }
    ...
    add_template_folder_setting() {
      new L.Setting(this.containerEl)
        .setName("テンプレートフォルダの場所")
        .setDesc("このフォルダ内のファイルがテンプレートとして利用可能になります。")
        .addSearch((e) => {
          new wn(this.app, e.inputEl),
            e
              .setPlaceholder("例：folder1/folder2")
    ...
    add_syntax_highlighting_settings() {
      let e = document.createDocumentFragment();
      e.append("編集モードで Templater コマンドの構文ハイライトを追加します。");
      let t = document.createDocumentFragment();
      t.append(
        "モバイルの編集モードで Templater コマンドの構文ハイライトを追加します（注意：使用方法によってはライブプレビューが壊れる可能性があります）。"
      ),
        new L.Setting(this.containerEl)
          .setName("デスクトップでの構文ハイライト")
          .setDesc(e)
          .addToggle((r) => {
            r.setValue(this.plugin.settings.syntax_highlighting).onChange(
              (i) => {
    ...
    add_auto_jump_to_cursor() {
      ...
      e.append(
        ...
        new L.Setting(this.containerEl)
          .setName("カーソルへの自動ジャンプ")
          .setDesc(e)
          .addToggle((t) => {
            t.setValue(this.plugin.settings.auto_jump_to_cursor).onChange(
              (r) => {
    ...
    add_trigger_on_new_file_creation_setting() {
      ...
      e.append(
        ...
        "Templater は日次ノートコアプラグイン、カレンダープラグイン、レビュープラグイン、ノートリファクタリングプラグインなど、他のプラグインと互換性を持つようになります。",
        e.createEl("br"),
        e.createEl("br"),
        "以下のフォルダテンプレートまたはファイル正規表現テンプレートのいずれかでルールを設定してください。",
        e.createEl("br"),
        e.createEl("br"),
        e.createEl("b", { text: "警告：" }),
        "作成時に未知または安全でない内容で新しいファイルを作成すると危険な場合があります。新しいファイルの内容が作成時に安全であることを確認してください。"
      ),
        new L.Setting(this.containerEl)
          .setName("新しいファイル作成時に Templater をトリガーする")
          .setDesc(e)
          .addToggle((t) => {
    ...
    add_templates_hotkeys_setting() {
      new L.Setting(this.containerEl).setName("テンプレートホットキー").setHeading();
      let e = document.createDocumentFragment();
      e.append("テンプレートをホットキーにバインドできます。"),
        new L.Setting(this.containerEl).setDesc(e),
        this.plugin.settings.enabled_templates_hotkeys.forEach((t, r) => {
          new L.Setting(this.containerEl)
            .addSearch((o) => {
              new tn(o.inputEl, this.plugin, Le.TemplateFiles),
                o
                  .setPlaceholder("例：folder1/template_file")
                  .setValue(t)
                  .onChange((a) => {
                    if (
                      a &&
            ...
            .addExtraButton((o) => {
              o.setIcon("up-chevron-glyph")
                .setTooltip("上に移動")
                .onClick(() => {
                  Dt(this.plugin.settings.enabled_templates_hotkeys, r, r - 1),
                    this.plugin.save_settings(),
                    this.display();
                });
            })
        ...
        new L.Setting(this.containerEl).addButton((t) => {
          t.setButtonText("テンプレートの新しいホットキーを追加")
            .setCta()
            .onClick(() => {
    ...
    add_folder_templates_setting() {
      new L.Setting(this.containerEl).setName("フォルダテンプレート").setHeading();
      let e = document.createDocumentFragment();
      e.append(
        "フォルダテンプレートは、新しい",
        ...
        e.createEl("br"),
        "Templaterは空のファイルを指定されたテンプレートで埋めます。",
        e.createEl("br"),
      ...
      let t = document.createDocumentFragment();
      t.append(
        "有効にすると、Templaterは以下で定義されたフォルダテンプレートを使用します。このオプションは以下のファイル正規表現テンプレートと相互に排他的であるため、一方を有効にすると他方は無効になります。"
      ),
        new L.Setting(this.containerEl)
          .setName("フォルダテンプレートを有効にする")
          .setDesc(t)
          .addToggle((r) => {
        ...
        !!this.plugin.settings.enable_folder_templates &&
          (this.plugin.settings.folder_templates.forEach((r, i) => {
            new L.Setting(this.containerEl)
              ...
              .addSearch((a) => {
                new tn(a.inputEl, this.plugin, Le.TemplateFiles),
                  a
              ...
              .addExtraButton((a) => {
                a.setIcon("up-chevron-glyph")
                  .setTooltip("上に移動")
                  .onClick(() => {
                    Dt(this.plugin.settings.folder_templates, i, i - 1),
                      this.plugin.save_settings(),
                      this.display();
                  });
              })
          ...
          new L.Setting(this.containerEl).addButton((r) => {
            r.setButtonText("新しいフォルダテンプレートを追加")
              .setTooltip("追加のフォルダテンプレートを追加")
              .setCta()
              .onClick(() => {
    ...
    add_file_templates_setting() {
      ...
      t.append(
        ...
        !!this.plugin.settings.enable_file_templates &&
            ...
            new L.Setting(this.containerEl)
              ...
              .addExtraButton((a) => {
                a.setIcon("up-chevron-glyph")
                  .setTooltip("上に移動")
                  .onClick(() => {
                    Dt(this.plugin.settings.file_templates, i, i - 1),
                      this.plugin.save_settings(),
                      this.display();
                  });
              })
          ...
          new L.Setting(this.containerEl).addButton((r) => {
            r.setButtonText("新しいファイル正規表現を追加")
              .setTooltip("追加のファイル正規表現を追加")
              .setCta()
              .onClick(() => {
    ...
    add_startup_templates_setting() {
      new L.Setting(this.containerEl).setName("起動時テンプレート").setHeading();
      let e = document.createDocumentFragment();
      e.append(
        ...
        new L.Setting(this.containerEl).addButton((t) => {
          t.setButtonText("新しい起動時テンプレートを追加")
            .setCta()
            .onClick(() => {
    ...
    add_user_script_functions_setting() {
      ...
      let e = document.createDocumentFragment();
      e.append(
        "このフォルダ内のすべてのJavaScriptファイルはCommonJSモジュールとして読み込まれ、カスタムユーザー関数をインポートします。",
        e.createEl("br"),
        ...
        new L.Setting(this.containerEl)
          .setName("スクリプトファイルフォルダの場所")
          .setDesc(e)
          .addSearch((r) => {
            new wn(this.app, r.inputEl),
              r
                .setPlaceholder("例：folder1/folder2")
    ...
    add_user_system_command_functions_setting() {
      ...
      if (
        ...
        new L.Setting(this.containerEl)
          .setName("ユーザーシステムコマンド関数")
          .setHeading(),
        new L.Setting(this.containerEl)
          .setName("ユーザーシステムコマンド関数を有効にする")
          .setDesc(e)
          .addToggle((t) => {
        ...
        new L.Setting(this.containerEl)
          .setName("タイムアウト")
          .setDesc("システムコマンドの最大タイムアウト（秒）。")
          .addText((o) => {
            o.setPlaceholder("タイムアウト")
              .setValue(this.plugin.settings.command_timeout.toString())
              .onChange((a) => {
                let l = Number(a);
                if (isNaN(l)) {
                  oe(new M("タイムアウトは数値である必要があります"));
                  return;
                }
          ...
          new L.Setting(this.containerEl)
            ...
            .setDesc(e)
            .addText((o) => {
              o.setPlaceholder("例：/bin/bash など")
...
var fr = ee(require("obsidian"));
var nn;
(function (t) {
  (t[(t.InsertTemplate = 0)] = "InsertTemplate"),
    (t[(t.CreateNoteTemplate = 1)] = "CreateNoteTemplate");
})(nn || (nn = {}));
var ni = class extends fr.FuzzySuggestModal {
  constructor(e) {
    super(e.app);
    (this.plugin = e), this.setPlaceholder("テンプレート名を入力してください...");
  }
  getItems() {
  ...
  getItemText(e) {
    ...
    if (
      ...
      (0, fr.normalizePath)(this.plugin.settings.templates_folder) != "/"
    ) {
...
var No = "Error_MobileUnsupportedTemplate",
  Mo =
...
var Me = ee(require("obsidian"));
var ft = ee(require("obsidian"));
var we = class {
  constructor(e) {
    this.plugin = e;
...
var ri = class extends we {
  ...
  generate_now() {
    return (e = "YYYY-MM-DD", t, r, i) => {
      ...
      return (
        typeof t == "string"
          ? (o = ft.moment.duration(t))
          : typeof t == "number" && (o = ft.moment.duration(t, "days")),
        (0, ft.moment)(r, i).add(o).format(e)
      );
    };
  }
  generate_tomorrow() {
    return (e = "YYYY-MM-DD") => (0, ft.moment)().add(1, "days").format(e);
  }
  generate_weekday() {
    return (e = "YYYY-MM-DD", t, r, i) => {
      if (r && !(0, ft.moment)(r, i).isValid())
      ...
      return (0, ft.moment)(r, i).weekday(t).format(e);
    };
  }
  generate_yesterday() {
    return (e = "YYYY-MM-DD") => (0, ft.moment)().add(-1, "days").format(e);
  ...
  ii = class extends we {
    ...
    generate_create_new() {
      return async (e, t, r = !1, i) => {
        if (((this.create_new_depth += 1), this.create_new_depth > Oo))
          throw (
            ((this.create_new_depth = 0),
            new M("Reached create_new depth limit (max = 10)"))
          );
    ...
    generate_cursor_append() {
      return (e) => {
        ...
        if (!t || !t.editor) {
          oe(new M("No active editor, can't append to cursor."));
          return;
        }
    ...
    generate_include() {
      return async (e) => {
        if (((this.include_depth += 1), this.include_depth > Oo))
          throw (
            ((this.include_depth -= 1),
            new M("Reached inclusion depth limit (max = 10)"))
          );
        let t;
        if (e instanceof le.TFile) t = await this.plugin.app.vault.read(e);
          ...
          if (!a)
            throw ((this.include_depth -= 1), new M(`File ${e} doesn't exist`));
    ...
    generate_path() {
      return (e = !1) => {
        ...
        else throw new M("app.vault is not a FileSystemAdapter instance");
        return e
    ...
    generate_selection() {
      return () => {
        ...
        if (!e || !e.editor)
          throw new M("Active editor is null, can't read selection.");
...
var oi = class extends we {
  ...
  async getRequest(e) {
    try {
      let t = await (0, Bo.requestUrl)(e);
      if (t.status < 200 && t.status >= 300)
        throw new M("Error performing GET request");
      return t;
    } catch {
      throw new M("Error performing GET request");
    }
...
> \u2014 ${o}`;
        ...
        return (
          new M("Error generating daily quote"), "Error generating daily quote"
        );
      }
    };
  }
  generate_random_picture() {
    return async (e, t, r = !1) => {
      try {
        ...
        return (
          new M("Error generating random picture"),
  ...
  generate_request() {
    return async (e, t) => {
      try {
        ...
        throw (console.error(r), new M("Error fetching and extracting value"));
      }
    };
  }
};
var ai = class extends we {
  constructor() {
    super(...arguments);
    this.name = "hooks";
    this.event_refs = [];
...
var Je = ee(require("obsidian"));
var ci = class extends Je.Modal {
  constructor(e, t, r, i) {
    super(e);
    this.prompt_text = t;
  ...
  onClose() {
    this.contentEl.empty(),
      this.submitted || this.reject(new M("Cancelled prompt"));
  }
  createForm() {
...
var Fo = ee(require("obsidian")),
  li = class extends Fo.FuzzySuggestModal {
...
var pi = class extends we {
  ...
  generate_prompt() {
    return async (e, t, r = !1, i = !1) => {
      let o = new ci(this.plugin.app, e, t, i),
  ...
  generate_suggester() {
    return async (e, t, r = !1, i = "", o) => {
      let a = new li(this.plugin.app, e, t, i, o),
...
var fi = class {
  constructor(e) {
    this.plugin = e;
    this.modules_array = [];
    this.modules_array.push(new ri(this.plugin)),
      this.modules_array.push(new ii(this.plugin)),
...
var bn = ee(require("obsidian"));
var di = class {
  constructor(e) {
    this.plugin = e;
    if (
      bn.Platform.isMobile ||
      !(this.plugin.app.vault.adapter instanceof bn.FileSystemAdapter)
    )
      this.cwd = "";
    else {
          ...
          : ((a = await this.plugin.templater.parser.parse_commands(a, r)),
            t.set(o, async (l) => {
              ...
              try {
                ...
                throw new M(`Error with User Template ${o}`, m);
              }
            })));
    }
    return t;
...
var mi = class {
  ...
  async load_user_script_function(e, t) {
    ...
    try {
      ...
      throw new M(`Failed to load user script at "${e.path}".`, c.message);
    }
...
var gi = class {
  constructor(e) {
    this.plugin = e;
    (this.user_system_functions = new di(e)),
      (this.user_script_functions = new mi(e));
  }
  async generate_object(e) {
    let t = {},
      r = {};
...
var hi = class {
  constructor(e) {
    this.plugin = e;
    (this.internal_functions = new fi(this.plugin)),
      (this.user_functions = new gi(this.plugin));
  }
  async init() {
  ...
  additional_functions() {
    return { app: this.plugin.app, obsidian: Ms };
  }
...
var Io = new TextDecoder("utf-8", { ignoreBOM: !0, fatal: !0 });
Io.decode();
var dr = new Uint8Array();
function mr() {
  return dr.byteLength === 0 && (dr = new Uint8Array(N.memory.buffer)), dr;
}
function jt(n, e) {
  return Io.decode(mr().subarray(n, n + e));
}
function vt(n) {
  En === He.length && He.push(He.length + 1);
  let e = En;
  return (En = He[e]), (He[e] = n), e;
}
var $e = 0,
...
var hr = new Int32Array();
function Ce() {
  return hr.byteLength === 0 && (hr = new Int32Array(N.memory.buffer)), hr;
}
function _i(n) {
  let e = typeof n;
...
var Ar = 32;
function qs(n) {
  if (Ar == 1) throw new Error("out of js stack");
  return (He[--Ar] = n), Ar;
}
function xi(n, e) {
  try {
    ...
    N.__wbindgen_exn_store(vt(t));
  }
}
var Lt = class {
    static __wrap(e) {
      let t = Object.create(Lt.prototype);
      return (t.ptr = e), t;
    }
    __destroy_into_raw() {
      let e = this.ptr;
    ...
    constructor(e, t, r, i, o, a, l) {
      let c = dt(e, N.__wbindgen_malloc, N.__wbindgen_realloc),
        d = $e,
        m = dt(t, N.__wbindgen_malloc, N.__wbindgen_realloc),
        y = $e,
        b = dt(l, N.__wbindgen_malloc, N.__wbindgen_realloc),
        E = $e,
    ...
    set opening_tag(e) {
      let t = dt(e, N.__wbindgen_malloc, N.__wbindgen_realloc),
        r = $e;
  ...
  rn = class {
    static __wrap(e) {
      let t = Object.create(rn.prototype);
      return (t.ptr = e), t;
    }
    __destroy_into_raw() {
      let e = this.ptr;
    ...
    render_content(e, t) {
      try {
        let a = N.__wbindgen_add_to_stack_pointer(-16),
          l = dt(e, N.__wbindgen_malloc, N.__wbindgen_realloc),
          c = $e;
        N.renderer_render_content(a, this.ptr, l, c, qs(t));
        var r = Ce()[a / 4 + 0],
          i = Ce()[a / 4 + 1],
          o = Ce()[a / 4 + 2];
        if (o) throw Ai(i);
        ...
        N.__wbindgen_add_to_stack_pointer(16), (He[Ar++] = void 0);
      }
    }
  };
...
function Hs() {
  ...
  return (
    ...
    (n.wbg.__wbindgen_string_get = function (e, t) {
      ...
      var o = Fs(i) ? 0 : dt(i, N.__wbindgen_malloc, N.__wbindgen_realloc),
        a = $e;
    ...
    (n.wbg.__wbindgen_debug_string = function (e, t) {
      let r = _i(Se(t)),
        i = dt(r, N.__wbindgen_malloc, N.__wbindgen_realloc),
        o = $e;
...
async function qo(n) {
  typeof n == "undefined" && (n = new URL("rusty_engine_bg.wasm", Rs.url));
  let e = Hs();
  (typeof n == "string" ||
    ...
    (n = fetch(n)),
    $s(e);
  let { instance: t, module: r } = await Ls(await n, e);
  return Ks(t, r);
}
var Lo = qo;
var Ho = Ri(
...
var Tn = class {
  constructor(e) {
    this.plugin = e;
    (this.functions_generator = new hi(this.plugin)), (this.parser = new yi());
  }
  async setup() {
  ...
  async create_new_note_from_template(e, t, r, i = !0) {
    ...
    let o = (e instanceof Me.TFile && e.extension) || "md",
      a = await Te(async () => {
        let m = t instanceof Me.TFolder ? t.path : t,
          y = this.plugin.app.vault.getAvailablePath(
            (0, Me.normalizePath)(`${m ?? ""}/${r || "Untitled"}`),
            o
          ),
          b = ro(y);
        return (
  ...
  async append_template_to_active_file(e) {
    let t = this.plugin.app.workspace.getActiveViewOfType(Me.MarkdownView),
      r = this.plugin.app.workspace.activeEditor;
    if (!r || !r.file || !r.editor) {
      oe(new M("No active editor, can't append templates."));
      return;
    }
    let { path: i } = r.file;
  ...
  overwrite_active_file_commands() {
    let e = this.plugin.app.workspace.activeEditor;
    if (!e || !e.file) {
      oe(new M("Active editor is null, can't overwrite content"));
      return;
    }
    ...
    for (; (o = i.nextNode()); ) {
      ...
      if (c !== null) {
        ...
        if (d !== null) {
          ...
          if (!m || !(m instanceof Me.TFile)) return;
          if (!a) {
            a = !0;
  ...
  static async on_file_creation(e, t, r) {
    if (!(r instanceof Me.TFile) || r.extension !== "md") return;
    let i = (0, Me.normalizePath)(e.plugin.settings.templates_folder);
    if (
      !(r.path.includes(i) && i !== "/") &&
      (await or(300), !e.files_with_pending_templates.has(r.path))
    )
      if (r.stat.size == 0 && e.plugin.settings.enable_folder_templates) {
        let o = e.get_new_file_template_for_folder(r.parent);
        if (!o) return;
        let a = await Te(async () => Ct(t, o), `Couldn't find template ${o}`);
        if (a == null) return;
    ...
    update_trigger_file_on_creation() {
      this.settings.trigger_on_file_creation
        ? ((this.trigger_on_file_creation_event = this.plugin.app.vault.on(
            "create",
            (e) => Tn.on_file_creation(this.templater, this.plugin.app, e)
          )),
    ...
    update_file_menu() {
      this.plugin.registerEvent(
        this.plugin.app.workspace.on("file-menu", (e, t) => {
          t instanceof $o.TFolder &&
            e.addItem((r) => {
              r.setTitle("テンプレートから新規ノートを作成")
...
var ki = ee(require("obsidian"));
var vi = ee(require("obsidian"));
var wi = class {
  constructor(e) {
    this.app = e;
  }
  async jump_to_next_cursor_location() {
    ...
    if (i) {
      let o = e instanceof vi.MarkdownView ? e.currentMode.getFoldInfo() : null;
      e.editor.setValue(r),
        o &&
          ...
          e instanceof vi.MarkdownView && e.currentMode.applyFoldInfo(o)),
...
var Gs = [
  ...
  Ws = new Set(Gs);
function Yo(n) {
  return typeof n == "string" && Ws.has(n);
}
function bi(n) {
  ...
  async get_all_functions_documentation(e, t) {
    ...
    if (e === "user") {
      ...
      let r = await Te(async () => {
        ...
        return await no(this.plugin.app, i);
  ...
  get_app_functions_documentation(e, t) {
    ...
    for (let c in i) {
      ...
      l.push({
        name: c,
        queryKey: m,
        definition: typeof i[c] == "function" ? `${d}(${io(i[c])})` : d,
        description: "",
        returns: "",
        example: "",
      });
...
var Ti = class extends Uo.EditorSuggest {
  constructor(e) {
    super(e.app);
    this.tp_keyword_regex =
      /tp\.(?<module>[a-z]*)?(?<fn_trigger>\.(?<fn>[a-zA-Z_.]*)?)?$/;
    this.documentation = new Ei(e);
  }
  onTrigger(e, t, r) {
  ...
  renderSuggestion(e, t) {
    if ((t.createEl("b", { text: e.name }), bi(e))) {
      if (e.args && this.getNumberOfArguments(e.args) > 0) {
        t.createEl("p", { text: "Parameter list:" });
        let r = t.createEl("ol");
        for (let [i, o] of Object.entries(e.args)) Hr(r, i, o.description);
      }
      e.returns && Hr(t, "Returns", e.returns);
    }
...
(function (n) {
  ...
  n.defineMode("javascript", function (e, t) {
    ...
    function O(s, p) {
      ...
      if (A == "#" && s.peek() == "!") return s.skipToEnd(), w("meta", "meta");
    ...
    function $(s) {
      return function (p, A) {
        ...
        if (o && p.peek() == "@" && p.match(b))
          return (A.tokenize = O), w("jsonld-keyword", "meta");
        for (; (F = p.next()) != null && !(F == s && !_); ) _ = !_ && F == "\\";
        return _ || (A.tokenize = O), w("string", "string");
      };
    }
    function K(s, p) {
      ...
      if (!(A < 0)) {
        ...
        for (var F = 0, Y = !1, z = A - 1; z >= 0; --z) {
          ...
          if (Ue >= 0 && Ue < 3) {
            ...
            for (; ; --z) {
              if (z == 0) return;
              var ua = s.string.charAt(z - 1);
              if (ua == je && s.string.charAt(z - 2) != "\\") {
                z--;
                break;
              }
            }
    ...
    function Ae(s, p) {
      if (p)
        ...
        } else return Oe(s, p.vars) ? p : new Ke(p.prev, new Ee(s, p.vars), !1);
      else return null;
    }
    function _e(s) {
      return (
    ...
    var Ht = new Ee("this", new Ee("arguments", null));
    function Re() {
      (h.state.context = new Ke(h.state.context, h.state.localVars, !1)),
        (h.state.localVars = Ht);
    }
    function Ze() {
    ...
    function Z(s, p) {
      return s == "var"
        ...
        ? f(ht)
        : s == "for"
        ? f(B("form"), Ze, Bi, Z, xe, D)
        : s == "class" || (c && p == "interface")
        ? ((h.marked = "keyword"), f(B("form", s == "class" ? s : p), Ii, D))
        : s == "variable"
        ? c && p == "declare"
          ? ((h.marked = "keyword"), f(Z))
          : c &&
          ...
          ? ((h.marked = "keyword"),
            p == "enum"
              ...
              : p == "type"
              ? f(Fi, q("operator"), V, q(";"))
              : f(B("form"), Be, q("{"), B("}"), On, D, D))
          : c && p == "namespace"
          ? ((h.marked = "keyword"), f(B("form"), W, Z, D))
          : c && p == "abstract"
          ? ((h.marked = "keyword"), f(Z))
          : f(B("stat"), Nn)
        : s == "switch"
        ? f(B("form"), wt, q("{"), B("}", "switch"), Ze, On, D, D, xe)
        : s == "case"
        ? f(W, q(":"))
        : s == "default"
        ? f(q(":"))
        : s == "catch"
        ? f(B("form"), Re, et, Z, D, xe)
        : s == "export"
        ? f(B("stat"), oa, D)
        : s == "import"
        ? f(B("stat"), aa, D)
    ...
    function kn(s, p, A) {
      if (h.state.fatArrowAt == h.stream.start) {
        var _ = A ? Dn : Cn;
        if (s == "(") return f(Re, B(")"), se(Tt, ")"), D, q("=>"), _, xe);
      ...
      return J.hasOwnProperty(s)
        ...
        ? f(ht, F)
        : s == "class" || (c && p == "interface")
        ? ((h.marked = "keyword"), f(B("form"), ia, D))
        : s == "keyword c" || s == "async"
        ? f(A ? ye : W)
        : s == "("
        ? f(B(")"), tt, q(")"), D, F)
    ...
    function nt(s, p) {
      return s == "," ? f(tt) : mt(s, p, !1);
    }
    function mt(s, p, A) {
      var _ = A == !1 ? nt : mt,
        F = A == !1 ? W : ye;
      if (s == "=>") return f(Re, A ? Dn : Cn, xe);
      if (s == "operator")
        return /\+\+|--/.test(p) || (c && p == "!")
          ? f(_)
          ...
          ? f(W, q(":"), F)
          : f(F);
      if (s == "quasi") return S(bt, _);
      if (s != ";") {
        if (s == "(") return an(ye, ")", "call", _);
        if (s == ".") return f(on, _);
    ...
    function Sn(s) {
      if (s == "}")
        return (h.marked = "string-2"), (h.state.tokenize = C), f(bt);
    }
    function Cn(s) {
      return I(h.stream, h.state), S(s == "{" ? Z : W);
    }
    function Dn(s) {
      return I(h.stream, h.state), S(s == "{" ? Z : ye);
    }
    function rt(s) {
      return function (p) {
        return p == "."
    ...
    function Pn(s, p) {
      if (p == "target") return (h.marked = "keyword"), f(mt);
    }
    function Nn(s) {
      return s == ":" ? f(D, Z) : S(nt, q(";"), D);
    }
    function on(s) {
      if (s == "variable") return (h.marked = "property"), f();
    }
    function Et(s, p) {
      if (s == "async") return (h.marked = "property"), f(Et);
      if (s == "variable" || h.style == "keyword") {
        ...
        if (c && _e(p)) return (h.marked = "keyword"), f(Et);
        if (s == "[") return f(W, Kt, q("]"), Ye);
        if (s == "spread") return f(ye, Ye);
        if (p == "*") return (h.marked = "keyword"), f(Et);
        if (s == ":") return S(Ye);
      }
    }
    function Mn(s) {
      return s != "variable" ? S(Ye) : ((h.marked = "property"), f(ht));
    }
    function Ye(s) {
      if (s == ":") return f(ye);
      if (s == "(") return S(ht);
    ...
    function Ni(s) {
      if (c && s == ":")
        return h.stream.match(/^\s*\w+\s+is\b/, !1) ? f(W, Jo, V) : f(V);
    }
    function Jo(s, p) {
    ...
    function V(s, p) {
      ...
      if (s == "{") return f(B("}"), yr, D, it);
      if (s == "(") return f(se(vr, ")"), Qo, it);
      if (s == "<") return f(se(V, ">"), V);
      if (s == "quasi") return S(jr, it);
    }
    function Qo(s) {
      if (s == "=>") return f(V);
    }
    ...
    function sn(s, p) {
      if (s == "variable" || h.style == "keyword")
        return (h.marked = "property"), f(sn);
      if (p == "?" || s == "number" || s == "string") return f(sn);
      if (s == ":") return f(V);
      if (s == "[") return f(q("variable"), zo, q("]"), sn);
      if (s == "(") return S(Yt, sn);
      if (!s.match(/[;\}\)\],]/)) return f();
    }
    function jr(s, p) {
    ...
    function Xo(s) {
      if (s == "}")
        return (h.marked = "string-2"), (h.state.tokenize = C), f(jr);
    }
    function vr(s, p) {
    ...
    function wr(s, p) {
      return p == "enum" ? ((h.marked = "keyword"), f(Hi)) : S(Be, Kt, gt, na);
    }
    function Be(s, p) {
    ...
    function Oi(s, p) {
      if (s == "keyword b" && p == "else") return f(B("form", "else"), Z, D);
    }
    function Bi(s, p) {
      if (p == "await") return f(Bi);
      if (s == "(") return f(B(")"), ra, D);
    }
    function ra(s) {
      return s == "var" ? f(wr, Rt) : s == "variable" ? f(Rt) : S(Rt);
    }
    function Rt(s, p) {
      return s == ")"
        ? f()
        ...
        ? f(Rt)
        : p == "in" || p == "of"
        ? ((h.marked = "keyword"), f(W, Rt))
        : S(W, Rt);
    }
    function ht(s, p) {
      if (p == "*") return (h.marked = "keyword"), f(ht);
      if (s == "variable") return be(p), f(ht);
      if (s == "(") return f(Re, B(")"), se(Tt, ")"), D, Ni, Z, xe);
      if (c && p == "<") return f(B(">"), se(Bn, ">"), D, ht);
    }
    function Yt(s, p) {
      if (p == "*") return (h.marked = "keyword"), f(Yt);
      if (s == "variable") return be(p), f(Yt);
      if (s == "(") return f(Re, B(")"), se(Tt, ")"), D, Ni, xe);
      if (c && p == "<") return f(B(">"), se(Bn, ">"), D, Yt);
    }
    function Fi(s, p) {
      if (s == "keyword" || s == "variable") return (h.marked = "type"), f(Fi);
      if (p == "<") return f(B(">"), se(Bn, ">"), D);
    }
    function Tt(s, p) {
      return (
        p == "@" && f(W, Tt),
    ...
    function ia(s, p) {
      return s == "variable" ? Ii(s, p) : Fn(s, p);
    }
    function Ii(s, p) {
      if (s == "variable") return be(p), f(Fn);
    }
    function Fn(s, p) {
      if (p == "<") return f(B(">"), se(Bn, ">"), D, Fn);
      if (p == "extends" || p == "implements" || (c && s == ","))
        return p == "implements" && (h.marked = "keyword"), f(c ? V : W, Fn);
    ...
    function ot(s, p) {
      ...
      if (s == "variable" || h.style == "keyword")
        return (h.marked = "property"), f(cn, ot);
      if (s == "number" || s == "string") return f(cn, ot);
      if (s == "[") return f(W, Kt, q("]"), cn, ot);
      if (p == "*") return (h.marked = "keyword"), f(ot);
      if (c && s == "(") return S(Yt, ot);
      if (s == ";" || s == ",") return f(ot);
      if (s == "}") return f();
      if (p == "@") return f(W, ot);
    }
    ...
    function In(s, p) {
      return s == "{"
        ? an(In, "}")
        : (s == "variable" && be(p), p == "*" && (h.marked = "keyword"), f(sa));
    }
    function Li(s) {
      if (s == ",") return f(In, Li);
    }
    function sa(s, p) {
      if (p == "as") return (h.marked = "keyword"), f(In);
    }
    function br(s, p) {
    ...
    function Hi() {
      return S(B("form"), Be, q("{"), B("}"), se(la, "}"), D, D);
    }
    function la() {
      return S(Be, gt);
    }
...
var Go = ee(require("@codemirror/language")),
  Wo = ee(require("@codemirror/state")),
  Vo = "templater",
  Si = "templater-command",
  Ci = "templater-inline",
  Vs = "templater-opening-tag",
  zs = "templater-closing-tag",
  Js = "templater-interpolation-tag",
  Qs = "templater-execution-tag",
  Di = class {
    constructor(e) {
      this.plugin = e;
      (this.cursor_jumper = new wi(e.app)), (this.activeEditorExtensions = []);
    }
    desktopShouldHighlight() {
      return (
        ki.Platform.isDesktopApp && this.plugin.settings.syntax_highlighting
      );
    }
    mobileShouldHighlight() {
      return (
        ki.Platform.isMobile && this.plugin.settings.syntax_highlighting_mobile
      );
    }
    async setup() {
      this.plugin.registerEditorSuggest(new Ti(this.plugin)),
        await this.registerCodeMirrorMode(),
        (this.templaterLanguage = Wo.Prec.high(
          Go.StreamLanguage.define(window.CodeMirror.getMode({}, Vo))
        )),
    ...
    async registerCodeMirrorMode() {
      ...
      window.CodeMirror.defineMode(Vo, function (r) {
        let i = {
          startState: function () {
            return {
          ...
          token: function (o, a) {
            if ((o.sol() && a.inCommand && (a.freeLine = !0), a.inCommand)) {
              ...
              if (o.match(/[-_]{0,1}%>/, !0)) {
                ...
                let m = a.tag_class;
                return (a.tag_class = ""), `line-${Ci} ${Si} ${zs} ${m}`;
              }
            ...
            if (l != null) {
              ...
              return (
                (a.inCommand = !0), `line-${Ci} ${Si} ${Vs} ${a.tag_class}`
              );
            }
...
var Pi = class extends xr.Plugin {
  async onload() {
    await this.load_settings(),
      (this.templater = new Tn(this)),
      await this.templater.setup(),
      (this.editor_handler = new Di(this)),
      await this.editor_handler.setup(),
      (this.fuzzy_suggester = new ni(this)),
      (this.event_handler = new _r(this, this.templater, this.settings)),
      this.event_handler.setup(),
      (this.command_handler = new ji(this)),
      this.command_handler.setup(),
      (0, xr.addIcon)("templater-icon", Mo),
      this.addRibbonIcon("templater-icon", "Templater", async () => {
        this.fuzzy_suggester.insert_template();
      }).setAttribute("id", "rb-templater-icon"),
      this.addSettingTab(new ti(this)),
  ...
  async load_settings() {
    this.settings = Object.assign({}, Po, await this.loadData());
  }
};
