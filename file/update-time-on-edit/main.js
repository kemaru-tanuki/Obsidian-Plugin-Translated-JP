  ...
  if (token === "YYYY") {
    throw new RangeError(
      "Use `yyyy` instead of `YYYY` (in `"
        .concat(format3, "`) for formatting years to the input `")
    ...
    throw new RangeError(
      "Use `d` instead of `D` (in `"
        .concat(format3, "`) for formatting days of the month to the input `")
        .concat(input, "`; see: https://git.io/fxCyr")
    );
  } else if (token === "DD") {
    throw new RangeError(
...
function preventOverflow(_ref) {
  ...
  if (checkMainAxis || checkAltAxis) {
    ...
    var offsetModifierValue = state.modifiersData.offset
      ...
      : 0;
    var tetherMin =
      popperOffsets2[mainAxis] + minOffset - offsetModifierValue - clientOffset;
...
var UpdateAllModal = class extends import_obsidian3.Modal {
  ...
  async onRun() {
    ...
    const el = new import_obsidian3.Setting(this.containerEl).addButton(
      (btn) => {
  ...
  async onOpen() {
    ...
    this.settingsSection = new import_obsidian3.Setting(contentEl)
      .addButton((btn) => {
        btn
          .setButtonText("Run")
          .setCta()
...
var UpdateAllCacheData = class extends import_obsidian4.Modal {
  ...
  async onRun() {
    ...
    const el = new import_obsidian4.Setting(this.containerEl).addButton(
      (btn) => {
        btn.setButtonText("Close").onClick(() => {
          this.close();
        });
    ...
    this.divContainer.replaceChildren(
      doneMessage,
      createBr2(),
      createBr2(),
      el
  ...
  async onOpen() {
    ...
    this.settingsSection = new import_obsidian4.Setting(contentEl)
      .addButton((btn) => {
        btn
          .setButtonText("Run")
          .setCta()
...
var UpdateTimeOnEditSettingsTab = class extends import_obsidian5.PluginSettingTab {
  ...
  display() {
    ...
    containerEl.empty();
    containerEl.createEl("h2", { text: "グローバル設定" });
    ...
    new import_obsidian5.Setting(this.containerEl)
      ...
      .addButton((cb) => {
        cb.setButtonText("全てのファイルを更新").onClick(() => {
          new UpdateAllModal(this.app, this.plugin).open();
        });
      });
    containerEl.createEl("h2", { text: "更新日時" });
    this.addFrontMatterUpdated();
    containerEl.createEl("h2", { text: "作成日時" });
    this.addEnableCreated();
    this.addFrontMatterCreated();
    this.addExcludedCreatedFoldersSetting();
    containerEl.createEl("h2", { text: "実験的設定" });
    new import_obsidian5.Setting(this.containerEl)
      .setName("ハッシュマッチャーを有効にする")
      .setDesc(
      ...
      .addToggle((cb) => {
        ...
        return cb
          .setValue(
            (_a = this.plugin.settings.enableExperimentalHash) != null
              ? _a
              : false
          )
      ...
      .addButton((cb) =>
        cb.setButtonText("初期キャッシュを埋める").onClick(() => {
  ...
  addDateFormat() {
    this.createDateFormatEditor({
      ...
      name: "日付形式",
      description: "読み書きの日付形式",
      setValue: (newValue) => (this.plugin.settings.dateFormat = newValue),
    });
  }
  createDateFormatEditor({ description, name, getValue, setValue }) {
    const createDoc = () => {
    ...
    let dformat = new import_obsidian5.Setting(this.containerEl)
      .setName(name)
      .setDesc(createDoc())
      .addText((text) =>
        text
  ...
  addTimeBetweenUpdates() {
    new import_obsidian5.Setting(this.containerEl)
      .setName("更新間隔の最小分数")
      .setDesc("ファイルの更新が頻繁すぎる場合は、この値を増やしてください。")
      .addSlider((slider) =>
        slider
          .setLimits(1, 30, 1)
  ...
  addEnableCreated() {
    new import_obsidian5.Setting(this.containerEl)
      .setName("作成されたフロントマターキーの更新を有効にする")
      .setDesc("現在、存在しない場合は現在時刻に設定されます")
      .addToggle((toggle) =>
        toggle
  ...
  addFrontMatterUpdated() {
    new import_obsidian5.Setting(this.containerEl)
      .setName("フロントマターの更新名")
      .setDesc("更新時間のフロントマター YAML のキー")
      .addText((text) => {
        var _a;
        return text
          .setPlaceholder("updated")
          .setValue((_a = this.plugin.settings.headerUpdated) != null ? _a : "")
          .onChange(async (value) => {
  ...
  addFrontMatterCreated() {
    ...
    new import_obsidian5.Setting(this.containerEl)
      .setName("フロントマターの作成名")
      .setDesc("作成時間のフロントマター YAML のキー")
      .addText((text) => {
        var _a;
        return text
          .setPlaceholder("updated")
          .setValue((_a = this.plugin.settings.headerCreated) != null ? _a : "")
          .onChange(async (value) => {
  ...
  addExcludedCreatedFoldersSetting() {
    ...
    this.doSearchAndRemoveList({
      currentList:
        (_a = this.plugin.settings.ignoreCreatedFolder) != null ? _a : [],
      setValue: async (newValue) => {
        this.plugin.settings.ignoreCreatedFolder = newValue;
      },
      name: "作成プロパティの更新から除外するフォルダ",
      description:
  ...
  addExcludedFoldersSetting() {
    this.doSearchAndRemoveList({
      ...
      name: "全ての更新から除外するフォルダ",
      description:
        "このフォルダ内で更新されたファイルは、更新と作成の更新をトリガーしません。",
    });
  }
  doSearchAndRemoveList({ currentList, setValue, description, name }) {
    let searchInput;
    new import_obsidian5.Setting(this.containerEl)
      .setName(name)
      .setDesc(description)
      .addSearch((cb) => {
        ...
        cb.setPlaceholder("例：folder1/folder2");
        cb.containerEl.addClass("time_search");
      })
      .addButton((cb) => {
        cb.setIcon("plus");
        cb.setTooltip("フォルダを追加");
        cb.onClick(async () => {
          if (!searchInput) {
            return;
          }
    ...
    currentList.forEach((ignoreFolder) =>
      new import_obsidian5.Setting(this.containerEl)
        ...
        .addButton((button) =>
          button.setButtonText("削除").onClick(async () => {
            await setValue(
              currentList.filter((value) => value !== ignoreFolder)
            );
            await this.saveSettings();
            this.display();
          })
