...
class AutoLinkTitleSettingTab extends obsidian.PluginSettingTab {
    ...
    display() {
        ...
        new obsidian.Setting(containerEl)
            .setName("デフォルトの貼り付けを拡張")
            .setDesc("デフォルトの貼り付けコマンドでリンク貼り付け時にタイトルを取得")
            .addToggle((val) => val
        ...
        new obsidian.Setting(containerEl)
            .setName("ドロップイベントを拡張")
            .setDesc("別プログラムからリンクをドラッグ＆ドロップ時にタタイトルを取得")
            .addToggle((val) => val
        ...
        new obsidian.Setting(containerEl)
            .setName("タイトルの最大長")
            .setDesc("タイトルの最大文字数を設定（０に設定すると無効化）")
            .addText((val) => val
        ...
        new obsidian.Setting(containerEl)
            .setName("選択テキストをタイトルとして優先")
            .setDesc("貼り付け時に取得タイトルより選択テキストを優先する")
            .addToggle((val) => val
        ...
        new obsidian.Setting(containerEl)
            .setName("ウェブサイトブラックリスト（カンマ区切り）")
            .setDesc("ウェブサイトタイトルの自動補完を無効化する文字列リスト（URL または任意のテキストを指定可能）")
            .addTextArea((val) => val
        ...
        new obsidian.Setting(containerEl)
            .setName("新規スクレイパーを使用")
            .setDesc("実験的新規スクレイパーを使用（デスクトップ版は動作良好、モバイル版は未対応）")
            .addToggle((val) => val
        ...
        new obsidian.Setting(containerEl)
            .setName("読みやすいプレースホルダーを使用")
            .setDesc("タイトル取得時に視認性の高いプレースホルダーを表示")
            .addToggle((val) => val
        ...
        new obsidian.Setting(containerEl)
            .setName("LinkPreview API キー")
            .setDesc("LinkPreview.net サービスの API キー（https://my.linkpreview.net/access_keys で取得可能）")
            .addText((text) => text
